...
public class JapaneseComicListAdapter extends RecyclerView.Adapter<JapaneseComicListAdapter.ViewHolder> {
    private List<Comic> comicList;
    private int itemLayout;
    private Context mContext;

    public JapaneseComicListAdapter(List<Comic> comicList, int itemLayout, Context mContext) {
