...
public class BookShelfAdapter extends RecyclerView.Adapter<BookShelfAdapter.ViewHolder> {
    ...
    private List<UserComicLike> userComicLikeList;
    private Context mContext;

    public BookShelfAdapter(List<UserComicLike> userComicLikeList, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        final UserComicLike userComicLike = userComicLikeList.get(i);
